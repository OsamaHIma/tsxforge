...
import { ArrowRightIcon, Terminal, Monitor, Cpu, Fingerprint, Layers, Box, Code2, Globe, Shield, Zap, Share2, Database, LayoutPanelTop } from "lucide-react";
    ...
    <HomeLayout {...baseOptions()}>
      <div className="relative min-h-screen w-full bg-[#0A0A0B] text-[#EDEDEF] selection:bg-[#8B5CF6]/30 overflow-x-hidden font-sans">
        ...
        <div className="relative z-10">
          {/* Section 1: Hero */}
          <section ref={heroRef} className="relative min-h-screen flex flex-col justify-center px-6 lg:px-12 max-w-7xl mx-auto pt-20">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <h1 className="flex flex-col text-6xl md:text-8xl lg:text-[120px] font-display font-bold leading-[0.9] tracking-tighter">
                  <motion.span variants={{ hidden: { opacity: 0, y: 40 }, visible: { opacity: 1, y: 0, transition: ITEM_TRANSITION } }}>THE</motion.span>
                  <motion.span variants={{ hidden: { opacity: 0, y: 40 }, visible: { opacity: 1, y: 0, transition: ITEM_TRANSITION } }}>COMPONENT</motion.span>
                  <motion.span 
                    variants={{ hidden: { opacity: 0, y: 40 }, visible: { opacity: 1, y: 0, transition: ITEM_TRANSITION } }}
                    className="text-transparent bg-clip-text bg-gradient-to-b from-[#8B5CF6] to-[#8B5CF6]/40"
                  >
                    FORGE
                  </motion.span>
                </h1>
                ...
                >
                  Architectural React primitives engineered for technical precision. 
                  Beyond UI—we build the logic that drives complex interfaces.
                </motion.p>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-24 border border-zinc-800 rounded-full flex items-center justify-center overflow-hidden">
                    <div className="w-[200%] h-px bg-gradient-to-r from-transparent via-[#8B5CF6]/50 to-transparent rotate-45" />
                  </div>
                </motion.div>
          ...
          <section className="py-32 px-6 lg:px-12 max-w-7xl mx-auto">
            ...
            >
               <span className="text-[10px] font-mono tracking-[0.3em] text-[#8B5CF6] uppercase">01 // PHILOSOPHY</span>
               <h2 className="text-4xl md:text-6xl font-display font-bold tracking-tighter">Engineered for <br/> Technical Precision.</h2>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-px bg-zinc-900 border border-zinc-900">
              {[
                ...
                >
                  ...
                  <span className="font-mono text-xs text-zinc-600 group-hover:text-[#8B5CF6] transition-colors">{feature.id}</span>
                  <div className="space-y-4">
                    <h3 className="text-xl font-bold tracking-tight uppercase">{feature.title}</h3>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12">
              <div className="grid lg:grid-cols-2 gap-24 items-start">
                ...
                <div className="order-2 lg:order-1 flex flex-col space-y-12">
                   <div className="space-y-4">
                      <span className="text-[10px] font-mono tracking-[0.3em] text-[#8B5CF6] uppercase">02 // SHOWCASE</span>
                      <h2 className="text-4xl font-display font-bold tracking-tighter uppercase">Atomic Elements</h2>
                   </div>
                   ...
                   <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="col-span-2 p-8 bg-zinc-900/50 border border-zinc-800 rounded-lg flex flex-col items-center justify-center space-y-6">
                         <div className="flex flex-wrap justify-center gap-4">
                            <Button size="sm" className="rounded-none font-mono text-[10px] uppercase tracking-widest px-6">Primary</Button>
                            <Button variant="outline" size="sm" className="rounded-none font-mono text-[10px] uppercase tracking-widest px-6">Secondary</Button>
                            <Button variant="ghost" size="sm" className="rounded-none font-mono text-[10px] uppercase tracking-widest px-6 underline underline-offset-4">Ghost</Button>
                         </div>
                         <span className="text-[9px] font-mono text-zinc-600 uppercase tracking-widest">Button Variants</span>
                      </div>
                      ...
                      <div className="p-8 bg-zinc-900/50 border border-zinc-800 rounded-lg flex flex-col space-y-4">
                         <div className="h-10 border-b border-zinc-700 flex items-center px-1">
                            <span className="text-[10px] font-mono text-zinc-400">Search_</span>
                         </div>
                         <div className="h-10 border-b border-[#8B5CF6] flex items-center px-1">
                            <span className="text-[10px] font-mono text-[#8B5CF6]">Active_Input</span>
                         </div>
                         <span className="text-[9px] font-mono text-zinc-600 uppercase tracking-widest mt-auto">Inputs</span>
                      </div>
                      ...
                      <div className="p-8 bg-[#8B5CF6]/5 border border-[#8B5CF6]/20 rounded-lg flex flex-col justify-between">
                         ...
                         <div className="space-y-1">
                            ...
                            <span className="text-[9px] font-mono text-zinc-500 uppercase">Synchronizing_data...</span>
                         </div>
                      </div>
                   </div>
                </div>
                ...
                <div className="order-1 lg:order-2 sticky top-32">
                  ...
                  >
                    ...
                    <div className="h-10 bg-zinc-900/50 border-b border-zinc-800 flex items-center justify-between px-4">
                      ...
                      <span className="text-[10px] font-mono text-zinc-600 uppercase tracking-widest">Forge_Logic.tsx</span>
                    </div>
                    ...
                    <div className="p-6 font-mono text-xs leading-relaxed overflow-x-auto overflow-y-hidden">
                      <div className="flex gap-4">
                        ...
                        <span><span className="text-[#8B5CF6]">import</span> &#123; <span className="text-emerald-400">Pagination</span>, <span className="text-emerald-400">Card</span> &#125; <span className="text-[#8B5CF6]">from</span> <span className="text-amber-200">"@tsxforge/core"</span>;</span>
                      </div>
                      <div className="flex gap-4">
                      ...
                      <div className="flex gap-4 text-zinc-500">
                        ...
                        <span><span className="text-[#8B5CF6]">export default function</span> <span className="text-blue-400">Dashboard</span>() &#123;</span>
                      </div>
                      <div className="flex gap-4">
                        <span className="text-zinc-700 select-none">04</span>
                        <span className="pl-4"><span className="text-[#8B5CF6]">const</span> [page, setPage] = <span className="text-blue-400">useState</span>(1);</span>
                      </div>
                      <div className="flex gap-4">
                      ...
                      <div className="flex gap-4">
                        ...
                        <span className="pl-4"><span className="text-[#8B5CF6]">return</span> (</span>
                      </div>
                      <div className="flex gap-4">
                        <span className="text-zinc-700 select-none">07</span>
                        <span className="pl-8 text-zinc-400">&lt;<span className="text-emerald-400">Pagination</span></span>
                      </div>
                      <div className="flex gap-4">
                        <span className="text-zinc-700 select-none">08</span>
                        <span className="pl-12 text-zinc-400">current=&#123;<span className="text-zinc-100">page</span>&#125;</span>
                      </div>
                      <div className="flex gap-4">
                        <span className="text-zinc-700 select-none">09</span>
                        <span className="pl-12 text-zinc-400">onChange=&#123;<span className="text-zinc-100">setPage</span>&#125;</span>
                      </div>
                      <div className="flex gap-4">
          ...
          <section className="py-32 overflow-hidden border-t border-zinc-900">
            <div className="max-w-7xl mx-auto px-6 lg:px-12 mb-16">
               <div className="flex flex-col space-y-4">
                  <span className="text-[10px] font-mono tracking-[0.3em] text-[#8B5CF6] uppercase">03 // CATALOG</span>
                  <h2 className="text-4xl font-display font-bold tracking-tighter uppercase">The Full Arsenal</h2>
               </div>
            </div>
            ...
            <div className="relative group/catalog">
               ...
               >
                  {[
                    { name: "Pagination", type: "Logic", icon: <Layers className="size-4" />, id: "01" },
                    { name: "ImageUpload", type: "Input", icon: <Monitor className="size-4" />, id: "02" },
                    { name: "PhoneInput", type: "Input", icon: <Fingerprint className="size-4" />, id: "03" },
                    { name: "Table", type: "Data", icon: <Database className="size-4" />, id: "04" },
                    { name: "DateTimePicker", type: "Input", icon: <Box className="size-4" />, id: "05" },
                    { name: "ColorPicker", type: "Input", icon: <Zap className="size-4" />, id: "06" },
                    { name: "Image", type: "Media", icon: <Share2 className="size-4" />, id: "07" },
                    { name: "Breadcrumb", type: "Nav", icon: <Code2 className="size-4" />, id: "08" },
                    { name: "ActionConfirm", type: "Logic", icon: <Shield className="size-4" />, id: "09" },
                    { name: "DocumentUpload", type: "Input", icon: <Globe className="size-4" />, id: "10" },
                    { name: "EmptyState", type: "Layout", icon: <LayoutPanelTop className="size-4" />, id: "11" },
                    { name: "Button", type: "Action", icon: <Cpu className="size-4" />, id: "12" },
                    { name: "Input", type: "Input", icon: <Terminal className="size-4" />, id: "13" },
                    { name: "Textarea", type: "Input", icon: <Layers className="size-4" />, id: "14" },
                  ].map((comp, i) => (
                    <motion.div 
                      key={comp.id}
                    ...
                    >
                       <div className="flex justify-between items-start">
                          <span className="text-[10px] font-mono text-zinc-700 group-hover/card:text-[#8B5CF6] transition-colors">{comp.id}</span>
                          <div className="text-zinc-500 group-hover/card:text-[#8B5CF6] transition-colors">{comp.icon}</div>
                       </div>
                       <div className="space-y-1">
                          <h4 className="font-bold tracking-tight text-lg uppercase">{comp.name}</h4>
                          <p className="text-[10px] font-mono text-zinc-600 uppercase tracking-widest">{comp.type}_Primitive</p>
                       </div>
                    </motion.div>
                  ))}
               </motion.div>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 mt-8">
               <span className="text-[9px] font-mono text-zinc-600 uppercase tracking-widest italic opacity-50">← Drag to navigate full inventory</span>
            </div>
          </section>
             ...
             <div className="relative z-10 max-w-4xl mx-auto text-center space-y-12">
                ...
                >
                   <h2 className="text-5xl md:text-7xl font-display font-bold tracking-tighter leading-tight">
                      Ready to Evolve <br/> 
                      <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8B5CF6] to-white/40">Your Dev Engine?</span>
                   </h2>
                </motion.div>
                ...
                >
                   Start building high-performance interfaces today with the world's most technical React component library. 
                   Open source, type-safe, and production-ready.
                </motion.p>
          ...
          <footer className="py-20 px-6 lg:px-12 border-t border-zinc-900 bg-black">
             <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-12 text-zinc-500 font-mono text-[10px] tracking-widest uppercase">
                <div className="space-y-6">
                   <div className="text-xl font-display font-bold text-[#EDEDEF] tracking-tighter">TSXFORGE</div>
                   <div className="opacity-50">© 2024 COLLECTIVE // ALL SYSTEMS GO</div>
                </div>

                <div className="grid grid-cols-2 sm:grid-cols-4 gap-12">
                   <div className="flex flex-col space-y-4">
                      <span className="text-zinc-300">Resources</span>
                      <Link to="/docs/$" params={{ _splat: "" }} className="hover:text-[#8B5CF6] transition-colors">Documentation</Link>
                      <Link to="/docs/$" params={{ _splat: "components/input" }} className="hover:text-[#8B5CF6] transition-colors">Components</Link>
                      <a href="#" className="hover:text-[#8B5CF6] transition-colors">Showcase</a>
                   </div>
                   <div className="flex flex-col space-y-4">
                      <span className="text-zinc-300">Connect</span>
                      <a href={`https://github.com/${gitConfig.user}/${gitConfig.repo}`} className="hover:text-[#8B5CF6] transition-colors">GitHub</a>
                      <a href="#" className="hover:text-[#8B5CF6] transition-colors">Discord</a>
                      <a href="#" className="hover:text-[#8B5CF6] transition-colors">X / Twitter</a>
                   </div>
                   <div className="flex flex-col space-y-4">
                      <span className="text-zinc-300">Archive</span>
                      <a href="#" className="hover:text-[#8B5CF6] transition-colors">Changelog</a>
                      <a href="#" className="hover:text-[#8B5CF6] transition-colors">Releases</a>
                      <a href={`https://github.com/${gitConfig.user}/${gitConfig.repo}/blob/${gitConfig.branch}/LICENSE`} className="hover:text-[#8B5CF6] transition-colors">License</a>
                   </div>
                   <div className="flex flex-col space-y-4">
