...
import { CheckCircle, ChevronDown } from '@hugeicons/core-free-icons'
...
const CountrySelectOption = ({
  ...
  return (
    <CommandItem className="gap-2 w-80" onSelect={handleSelect}>
...
const FlagComponent = ({ country, countryName }: RPNInput.FlagProps) => {
  ...
  return (
    <span className="flex h-5 w-8 overflow-hidden rounded-sm bg-foreground/20 [&_svg:not([class*='size-'])]:size-full">
